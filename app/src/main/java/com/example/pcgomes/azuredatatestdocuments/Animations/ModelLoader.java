...
public class ModelLoader {
  ...
  private final WeakReference<Inicialize> owner;

  ModelLoader(Inicialize owner) {
    this.owner = new WeakReference<>(owner);
  }

  /**
   * Starts loading the model specified. The result of the loading is returned asynchrounously via
   * {@link Inicialize#setRenderable(int, ModelRenderable)} or {@link
   * Inicialize#onException(int, Throwable)}.
   *
