...
import com.example.pcgomes.azuredatatestdocuments.Reports.Profile;
...
//            @Override
//            public void onClick(View v) {
//                Intent c = new Intent(getApplicationContext(), Inicialize.class);
//                startActivity(c);
//            }
//        });
     ...
     */
    public static void onSignOutClicked(Context c) {
        /* Attempt to get a user and acquireTokenSilent
         * If this fails we do an interactive request
         */
        sampleApp.getAccounts(new PublicClientApplication.AccountsLoadedCallback() {
                                ...
                                new PublicClientApplication.AccountsRemovedCallback() {
                                    ...
                                    public void onAccountsRemoved(Boolean isSuccess) {
                                        if (isSuccess) {
                                            ...
                                            Toast.makeText(c, "Signed Out!", Toast.LENGTH_SHORT)
                                                    .show();
    ...
    private void updateGraphUI(JSONObject graphResponse) throws JSONException {
        ...
        intent.putExtra("userPrincipalName", userPrincipalName);
